...
import {AddButtonList, List, TasksList, } from "./components/index";
...
const HomeList = () => {
  ...
  /*useEffect(() => {
    ...
    }, [lists, navigate.location.pathname]);*/
    
  
    return (
      <div className="todo">
        <div className="todo__sidbar">
        <List 
          items={[
          {
            active: true,
